...
export default function TariffSchedulePage() {
  return <main className="relative z-1 px-5 pb-24 pt-32 sm:px-8"><div className="mx-auto max-w-[1080px]">
    ...
    <TariffStatusBlock />
    <aside className="mt-7 border-l-2 border-[var(--color-accent)] pl-4 text-sm leading-relaxed text-[var(--color-ink-secondary)]"><strong className="text-[var(--color-ink)]">Canada Section 338 notice.</strong> U.S. note 51 is pending merge, so membership is not determined across the schedule. A line-specific warning appears only on the encoded witness beer line; no other membership is inferred.</aside>
