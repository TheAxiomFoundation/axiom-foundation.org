...
const MEMBERS = [
  ...
  },
  {
    ...
    bio: [
      "Ariel leads Axiom's external strategy — partnerships, funding, policy, and the field — after more than a decade of senior leadership making government benefits computable, humane, and accountable. As Director of Design and Product at the NYC Mayor's Office for Economic Opportunity, she founded the nation's first municipal service design studio and built and led ACCESS NYC, the first open-source, API-driven benefits screener. She conducted some of the earliest US research on rules-as-code approaches and has driven the field since: as Senior Director at Georgetown University's Beeck Center for Social Impact + Innovation, she led the Digital Benefits Network and convened the national Rules as Code Community of Practice. Earlier she was Director of Civic Innovation at Sidewalk Labs and a 2013 Code for America Fellow.",
    ],
  },
  {
