...
const getFilename = (example: ExampleType, format: FormatTab): string => {
  const filenames: Record<ExampleType, Record<FormatTab, string>> = {
    niit: {
      rulespec: "rulespec-us/statutes/26/1411/a.yaml",
      dmn: "niit.dmn",
      openfisca:
    ...
    "aca-ptc": {
      rulespec: "rulespec-us/statutes/26/36B/b/3/A.yaml",
      dmn: "aca_ptc.dmn",
      openfisca:
    ...
    "std-ded": {
      rulespec: "rulespec-us/statutes/26/63/c/5.yaml",
    ...
    "ny-eitc": {
      rulespec: "rulespec-us-ny/statutes/tax/606/d.yaml",
      dmn: "ny_eitc.dmn",
...
export function FormatComparison() {
  return (
    <section id="format" className="relative z-1 py-32 px-8">
      <div className="max-w-[1280px] mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="font-body text-lg text-[var(--color-ink-secondary)] max-w-[640px] mx-auto leading-relaxed">
            A side-by-side look at the same statute encoded in RuleSpec, DMN,
            OpenFisca, and Catala &mdash;{" "}
            <span className="serif-italic text-[var(--color-ink)]">
              and what each one chooses to leave out
            </span>
            .
          </p>
        </div>
            ...
            <table className="w-full border-collapse font-body text-[0.9rem]">
              ...
              <tbody>
                {[
                  ...
                  { cap: "File format", dmn: "XML", of: "Py + YAML", cat: "Custom", rulespec: "YAML" },
              ...
              desc: (
                <>
                  ...
                  <code className="font-mono text-[0.8rem] px-1.5 py-0.5 bg-[var(--color-accent-light)] rounded text-[var(--color-accent)]">
                    rulespec-us/statutes/26/24/d/1/B.yaml
                  </code>{" "}
